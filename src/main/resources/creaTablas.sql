...
INSERT INTO SneakerSociety.venta (id_venta,id_factura,id_producto,precio,cantidad) values
(1,1,5,45000,3),
(2,1,9,15780,2),
(3,1,10,15000,3),
(4,2,5,45000,1),
...
create table SneakerSociety.rol (
...
insert into SneakerSociety.rol (id_rol, nombre, id_usuario) values
